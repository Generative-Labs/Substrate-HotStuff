...
pub struct Synchronizer {
	...
	/// processing will resume when we get the missing batches in the store or we no longer need
	/// them. It also keeps the round number and a timestamp (`u128`) of each request we sent.
