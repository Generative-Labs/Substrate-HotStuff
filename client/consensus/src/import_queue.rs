...
use sp_consensus_hotstuff::{inherents::HotstuffInherentData, HotstuffApi};
...
where
	...
	C::Api: BlockBuilderApi<B> + HotstuffApi<B, AuthorityId<P>> + ApiExt<B>,
	P: Pair,
...
where
	Block: BlockT,
	C::Api: BlockBuilderApi<Block> + HotstuffApi<Block, AuthorityId<P>> + ApiExt<Block>,
	C: 'static
